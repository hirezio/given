# `@hirez_io/vitest-given` 📃👌

A vitest addon that helps you clean up your microtests by breaking them into a **"Given / When / Then"** structure.

[![npm version](https://img.shields.io/npm/v/@hirez_io/vitest-given.svg?style=flat-square)](https://www.npmjs.org/package/@hirez_io/vitest-given)
[![npm downloads](https://img.shields.io/npm/dm/@hirez_io/vitest-given.svg?style=flat-square)](http://npm-stat.com/charts.html?package=@hirez_io/vitest-given&from=2017-07-26)
...
```
npm install -D @hirez_io/vitest-given
```

## Configuring Vitest

Add the following line to your vitest config:
...
You should add `@hirez_io/vitest-given` to your `types` property in your `tsconfig.json` (or `tsconfig.spec.json`) like this:
...

{
  ...
  "types": [
      "vitest",
      "vitest/globals",
      "@hirez_io/vitest-given", // <-- ADD THIS
...
or else it won't find `@hirez_io/vitest-given` global types.
...
<div align="center">
  <a href="https://hirez.io?utm_medium=Open_Source&utm_source=Github&utm_campaign=Lead_Generation&utm_content=vitest_given_readme_banner">
